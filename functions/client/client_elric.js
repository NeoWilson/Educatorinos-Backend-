...
const optionGetStageProgress = {
    method: "GET",
    url: "http://localhost:5001/complement-4254e/us-central1/app/elric/getCurrentWorldStatus",
    headers: {
    "Authorization": "Basic ",
...
const optionPostUpdateSectionScore = {
    method: "POST",
    url: "http://localhost:5001/complement-4254e/us-central1/app/elric/setSectionStars",
    headers: {
    "Authorization": "Basic ",
    "Content-Type": "application/json;charset=utf-8"
    },
...
const optionPostCreateAccount = {
    method: "POST",
    url: "http://localhost:5001/complement-4254e/us-central1/app/elric/createAccount",
    headers: {
    "Authorization": "Basic ",
    "Content-Type": "application/json;charset=utf-8"
    },
